...
public class GetWeatherCurrentLocation {

    static WeatherManager weatherManager = new WeatherManager(new HttpWeatherApi());

    public List<Double> getCurrentCoordinatesActualLocation(String city) {
    ...
    public static Map<String, Object> getDailyForecastActualLocation(double lat, double lon, String language) throws IOException, JSONException {
